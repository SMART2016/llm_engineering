...
2. **The model scores every possible next word.** Think of it as rating every word in its vocabulary (tens of thousands of words). Each word gets a score—higher score means the model thinks the word fits better next.
3. **Turn scores into probabilities.** These scores are turned into percentages that add up to 100%. Now you can say things like \"there's a 35% chance the next word is 'with'\".
...
5. **Pick one word based on the chosen strategy.** This is where different decoding algorithms come in:
   - **Greedy**: pick the single highest probability word—no randomness.
...
- From "The nice": "The nice woman" (50% × 40% = 20%)
- From "The nice": "The nice person" (50% × 35% = 17.5%)
- From "The dog": "The dog has" (30% × 90% = 27%) ✨ **This is best!**
- From "The dog": "The dog is" (30% × 60% = 18%)
...
graph TD
    subgraph Confident["Scenario 1: Confident"]
        ...
        C2["paris (7%)"] --> CSum2["92% ✓ Stop here!"]
        C3["Lyon (3%)"] -.-> Rejected1["Not needed ❌"]
    end
    ...
    subgraph Uncertain["Scenario 2: Uncertain"]
        ...
        U5["12th word"] --> USum5["92% ✓ Stop here!"]
    end
...
This repeated loop—from context, to probabilities, to decoding choice, to updated context—is the heartbeat of how modern language models write sentences, paragraphs, or entire stories.

---

## Common Misconceptions

### "More randomness = better creativity" ❌
...
### "You always need the most advanced method" ❌
